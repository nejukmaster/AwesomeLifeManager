...
public class PlanManager : Manager
{
    ...
    void mapping(){
        ...
        planDic.Add("01", new Plan("basic01",10, () => { turnProcessPopup.AddLog("도덕성 +10"); theStatusManager.IncreaseStatus("도덕성", 10); turnProcessPopup.AddLog("친화력 +20"); theStatusManager.IncreaseStatus("친화력", 20); return true; }, null,true));
